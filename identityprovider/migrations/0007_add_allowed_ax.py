...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpenIDRPConfig.allowed_ax'
        db.add_column('ssoopenidrpconfig', 'allowed_ax',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpenIDRPConfig.allowed_ax'
        db.delete_column('ssoopenidrpconfig', 'allowed_ax')
    ...
    models = {
        'identityprovider.account': {
            ...
            'openid_identifier': ('django.db.models.fields.TextField', [], {'default': "u'XJm6fny'", 'unique': 'True'}),
