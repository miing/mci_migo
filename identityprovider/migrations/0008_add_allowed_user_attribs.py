...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpenIDRPConfig.allowed_user_attribs'
        db.add_column('ssoopenidrpconfig', 'allowed_user_attribs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpenIDRPConfig.allowed_user_attribs'
        db.delete_column('ssoopenidrpconfig', 'allowed_user_attribs')
    ...
    models = {
        'identityprovider.account': {
            ...
            'openid_identifier': ('django.db.models.fields.TextField', [], {'default': "u'B4xBChz'", 'unique': 'True'}),
