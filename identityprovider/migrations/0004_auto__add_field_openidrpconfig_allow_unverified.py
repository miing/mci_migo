...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'OpenIDRPConfig.allow_unverified'
        db.delete_column('ssoopenidrpconfig', 'allow_unverified')
    ...
    models = {
        ...
        'identityprovider.account': {
            ...
            'openid_identifier': ('django.db.models.fields.TextField', [], {'default': "u'w8sX6NT'", 'unique': 'True'}),
